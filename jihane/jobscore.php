                                            ...
                                            <div class="row">
                                                <div class="btn-group">
                                                    ...
                                                    <button class="btn btn-info" data-bs-toggle="modal"
                                                        data-bs-target="#staticBackdrop<?php echo $row['id_c']; ?>"><span
                                                            class="bi bi-zoom-in"></span></button>
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="staticBackdrop<?php echo $row['id_c']; ?>"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            ...
                                                            <a href="register_recruteur.php"
                                                                ...
                                                                <div class="modal-footer d-flex">
                                                                    <a href="../pdf/cvpdf.php?id=<?php echo $row['id_c']; ?>&action=V"
                                                                        class="btn btn-info btn-sm col-6">
                                                                        Show CV</a>
                                                                </div>
                                                            </div>
